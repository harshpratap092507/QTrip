...
async function fetchReservations() {
  ...
  try{
    let name = await fetch(config.backendEndpoint + '/reservations');
    console.log(name);
...
Note:1. The date of adventure booking should appear in the format D/MM/YYYY (en-IN format) Example:  4/11/2020 denotes 4th November, 2020
